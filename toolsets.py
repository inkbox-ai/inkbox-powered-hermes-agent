...
TOOLSETS = {
    ...
    "hermes-inkbox": {
        "description": "Inkbox bot toolset — unified email + SMS + voice via inkbox.ai (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
